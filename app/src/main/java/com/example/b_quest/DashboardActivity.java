...
public class DashboardActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        ...
        switch (id) {
            ...
            case R.id.home:
                ...
                Intent intent0 = new Intent(DashboardActivity.this, DashboardActivity.class);
                startActivity(intent0);
                break;

            case R.id.nav_profile:
                Toast.makeText(getApplicationContext(), "profile", Toast.LENGTH_LONG).show();
                Intent intent1 = new Intent(DashboardActivity.this, MyProfile2.class);
                startActivity(intent1);
                break;

            case R.id.settings:
                Toast.makeText(getApplicationContext(), "settings", Toast.LENGTH_LONG).show();
                Intent intent2 = new Intent(DashboardActivity.this, Settings.class);
    ...
    public void browser1(View view){
        Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/Drcq3IxTgTs"));
